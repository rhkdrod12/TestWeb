            	...
            	<c:choose>
            		<c:when test="${sessionScope.user == null }">
            			<li class="dropdown">
		                    ...
		                    <ul class="dropdown-menu">
		                        <li><a href="${pageContext.request.contextPath}/user/login.user?reqURI=${reqURI}">로그인</a></li>
            		...
            		<c:otherwise>
            			<li class="dropdown">
            				...
            				<ul class="dropdown-menu">
		                        <li><a href="${pageContext.request.contextPath}/user/logout.user">LOGOUT</a></li>
		                        <li><a href="${pageContext.request.contextPath}/user/mypage.user">회원정보</a></li>
		                    </ul>
            			</li>
            		</c:otherwise>
            	</c:choose>
