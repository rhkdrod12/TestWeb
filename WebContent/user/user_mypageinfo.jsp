	                    ...
	                    <table class="table">
	                        <tbody class="m-control">
	                            ...
	                            <tr>
	                                ...
	                                <td><input class="form-control input-sm" type="text" name="name" value="${sessionScope.user.name }">&nbsp;<span id=checkName></span></td>
	                            </tr>
	                            <tr>
	                                <td class="m-title">*비밀번호</td>
	                                <td><input class="form-control input-sm" type="password" name="pw" id="pw" onkeyup="check_pw()">&nbsp;<span id=checkPw></span></td>
	                            </tr>
	                            <tr>
	                                <td class="m-title">*비밀번호확인</td>
	                                <td><input class="form-control input-sm" type="password" name="pwChk"  id="pw2" onkeyup="check_pw()">&nbsp;<span id=checkPwChk></span></td>
	                            </tr>
	                            <tr>
	                                <td class="m-title">*E-mail</td>
	                                <td>
	                                    <input class="form-control input-sm" type="text" name="email1" value="${sessionScope.user.email1}">@
	                                    <select class="form-control input-sm sel" style="width: 100px;">
	                                    ...
	                                    <button class="btn btn-info" type="button" onclick="print();">중복확인</button>
	                                </td>
	                            </tr>
	                            <tr>
...
<script type="text/javascript">
	...
	function check(){
		...
		var pw = document.modify_form.pw.value;
		var pwChk = document.modify_form.pwChk.value;
		
		if(!exp1.test(document.modify_form.id.value)){
		...
		if (document.modify_form.pw.value != document.modify_form.pwChk.value){
			document.getElementById('checkPwChk').innerHTML='비밀번호가 일치하지 않습니다.';
            document.getElementById('checkPwChk').style.color='red';
            flag = false;
		}
